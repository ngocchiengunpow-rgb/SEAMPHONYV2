            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 w-full">
                <div className="flex flex-col items-center text-center">
                    ...
                    >
                        ...
                        {/* Product Image Showcase placeholder */}
                        <div className="relative group perspective-1000">
                            ...
                            <div className="absolute top-4 -right-4 bg-primary-cta text-white font-bold px-4 py-2 rounded-lg shadow-xl z-20 transform rotate-6 border border-white/20">
                                85% Khách hàng F&B sẵn sàng dùng thử!
                            </div>
                            <div className="relative aspect-[4/3] bg-secondary-bg rounded-[2rem] border border-border shadow-2xl overflow-hidden flex flex-col items-center justify-center transform transition-all duration-700 hover:rotate-yd-12 hover:scale-[1.02]">
                                <img src="/hero-custom.png" alt="Prototype ván ép tiêu âm Seamphony" className="w-full h-full object-cover" onError={(e) => { e.currentTarget.style.display = 'none'; e.currentTarget.nextElementSibling.style.display = 'flex'; }} />
                                <div className="hidden absolute inset-0 flex-col items-center justify-center text-center p-6 bg-secondary-bg">
                                    <span className="text-text-muted text-sm font-semibold uppercase tracking-widest mb-2">Ảnh mẫu Ván ghép Seamphony</span>
                                </div>
                            </div>
                        </div>
                    </motion.div>
