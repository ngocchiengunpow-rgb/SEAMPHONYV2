                ...
                <div className="relative border-l-2 border-border ml-6 md:ml-0 md:border-none space-y-16">
                    ...
                    >
                        ...
                        <div className="md:w-5/12 ml-6 md:ml-0 md:text-right md:pr-12 w-full">
                            <div className="bg-white p-6 rounded-3xl border border-border/50 shadow-sm hover:shadow-xl transition-all duration-300 inline-block text-left w-full md:text-right hover:-translate-y-1">
                                <span className="inline-block px-4 py-1.5 rounded-full bg-primary-cta/10 text-primary-cta font-bold text-sm tracking-wider uppercase mb-3">Năm 1</span>
                                <h3 className="text-2xl font-heading font-bold text-text-main mb-4">Hoàn thiện pilot & chứng minh</h3>
                                <ul className="space-y-3 font-body text-text-muted md:ml-auto md:mr-0 inline-block text-left w-full">
                                    <li className="flex gap-2"><span>•</span> <span>Thiết lập xưởng pilot 150 – 200 m², hoàn thiện quy trình kỹ thuật 6 bước.</span></li>
                                    <li className="flex gap-2"><span>•</span> <span>Lắp đặt 3 – 5 công trình demo (café, homestay) và đo mức ồn trước – sau.</span></li>
                                    <li className="flex gap-2"><span>•</span> <span>Ký kết 2 – 3 thoả thuận thu gom vải vụn với xưởng may địa phương.</span></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className="md:w-5/12 ml-6 md:ml-0 md:pl-12 w-full mt-6 md:mt-0">
                            <div className="bg-white p-6 rounded-3xl border border-border/50 shadow-sm hover:shadow-xl transition-all duration-300 inline-block text-left w-full hover:-translate-y-1">
                                <span className="inline-block px-4 py-1.5 rounded-full bg-accent/10 text-accent font-bold text-sm tracking-wider uppercase mb-3">Năm 2</span>
                                <h3 className="text-2xl font-heading font-bold text-text-main mb-4">Ổn định sản lượng & dòng tiền</h3>
                                <ul className="space-y-3 font-body text-text-muted inline-block text-left w-full">
                                    ...
                                    <li className="flex gap-2"><span>•</span> <span>Mở rộng kênh B2B: phục vụ 10+ nhà thầu nội thất, kiến trúc sư.</span></li>
                                    <li className="flex gap-2"><span>•</span> <span>Đạt cột mốc dòng tiền dương.</span></li>
                                </ul>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="md:w-5/12 ml-6 md:ml-0 md:text-right md:pr-12 w-full mt-6 md:mt-0">
                            <div className="bg-white p-6 rounded-3xl border border-border/50 shadow-sm hover:shadow-xl transition-all duration-300 inline-block text-left w-full md:text-right hover:-translate-y-1">
                                <span className="inline-block px-4 py-1.5 rounded-full bg-green-500/10 text-green-600 font-bold text-sm tracking-wider uppercase mb-3">Năm 3+</span>
                                <h3 className="text-2xl font-heading font-bold text-text-main mb-4">Nhân rộng "micro-hub tuần hoàn"</h3>
                                <ul className="space-y-3 font-body text-text-muted md:ml-auto md:mr-0 inline-block text-left w-full">
                                    <li className="flex gap-2"><span>•</span> <span>Nhân rộng mô hình sang 2 – 3 cụm dệt may – dịch vụ khác.</span></li>
                                    <li className="flex gap-2"><span>•</span> <span>Mỗi cụm hình thành một "micro-hub" thu gom và sản xuất tại chỗ.</span></li>
                                    <li className="flex gap-2"><span>•</span> <span>Hướng tới tái chế hàng chục tấn vải vụn mỗi năm.</span></li>
                                </ul>
                            </div>
                        </div>
                        <div className="md:w-5/12 hidden md:block"></div>
