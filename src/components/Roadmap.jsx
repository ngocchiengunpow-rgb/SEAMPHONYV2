        ...
        <section id="roadmap" className="py-24 bg-secondary-bg relative border-t border-border/50">
            <div className="max-w-5xl mx-auto px-6 lg:px-12">
                ...
                <div className="relative border-l-2 border-border ml-6 md:ml-0 md:border-none space-y-16">
                    ...
                    >
                        <div className="absolute left-[-33px] md:left-1/2 md:-translate-x-1/2 w-4 h-4 rounded-full bg-primary-cta shadow-[0_0_0_8px_rgba(234,88,12,0.1)] border-2 border-white z-10"></div>
                        <div className="md:w-5/12 ml-6 md:ml-0 md:text-right md:pr-12 w-full">
                            ...
                            <ul className="space-y-3 font-body text-text-muted md:ml-auto md:mr-0 inline-block text-left">
                    ...
                    <motion.div
                        ...
                        className="relative flex flex-col md:flex-row items-center md:justify-between w-full"
                    >
                        <div className="absolute left-[-33px] md:left-1/2 md:-translate-x-1/2 w-4 h-4 rounded-full bg-accent shadow-[0_0_0_8px_rgba(37,99,235,0.1)] border-2 border-white z-10"></div>
                        <div className="md:w-5/12 hidden md:block"></div>
                        <div className="md:w-5/12 ml-6 md:ml-0 md:pl-12 w-full mt-6 md:mt-0">
                            ...
                            <ul className="space-y-3 font-body text-text-muted inline-block text-left">
                    ...
                    <motion.div
                        ...
                        className="relative flex flex-col md:flex-row items-center md:justify-between w-full"
                    >
                        <div className="absolute left-[-33px] md:left-1/2 md:-translate-x-1/2 w-4 h-4 rounded-full bg-green-500 shadow-[0_0_0_8px_rgba(34,197,94,0.1)] border-2 border-white z-10"></div>
